...
namespace EX {
  ...
  //          }
	...
	public static class Ex
	{
        ...
        public static bool IfAll(params bool[] conditions)
        {
            foreach (bool condition in conditions)
                if (!condition)
                    return false;
		...
		public static bool IfAtLeastX(int amt, params bool[] conditions)
		{
			int countTrue = 0;
			foreach (bool condition in conditions)
			{
		...
		public static PrimeTween.Ease EasingFunctionToPrimeTweenEase(EasingFunction.Ease ease)
		{
			return ease switch
			{
				EasingFunction.Ease.Linear => PrimeTween.Ease.Linear,
				EasingFunction.Ease.Spring => PrimeTween.Ease.Default,
				EasingFunction.Ease.QuadIn => PrimeTween.Ease.InQuad,
				EasingFunction.Ease.QuadOut => PrimeTween.Ease.OutQuad,
				EasingFunction.Ease.QuadInOut => PrimeTween.Ease.InOutQuad,
				EasingFunction.Ease.CubicIn => PrimeTween.Ease.InCubic,
				EasingFunction.Ease.CubicOut => PrimeTween.Ease.OutCubic,
				EasingFunction.Ease.CubicInOut => PrimeTween.Ease.InOutCubic,
				EasingFunction.Ease.QuartIn => PrimeTween.Ease.InQuart,
				EasingFunction.Ease.QuartOut => PrimeTween.Ease.OutQuart,
				EasingFunction.Ease.QuartInOut => PrimeTween.Ease.InOutQuart,
				EasingFunction.Ease.QuintIn => PrimeTween.Ease.InQuint,
				EasingFunction.Ease.QuintOut => PrimeTween.Ease.OutQuint,
				EasingFunction.Ease.QuintInOut => PrimeTween.Ease.InOutQuint,
				EasingFunction.Ease.SineIn => PrimeTween.Ease.InSine,
				EasingFunction.Ease.SineOut => PrimeTween.Ease.OutSine,
				EasingFunction.Ease.SineInOut => PrimeTween.Ease.InOutSine,
				EasingFunction.Ease.ExponentialIn => PrimeTween.Ease.InExpo,
				EasingFunction.Ease.ExponentialOut => PrimeTween.Ease.OutExpo,
				EasingFunction.Ease.ExponentialInOut => PrimeTween.Ease.InOutExpo,
				EasingFunction.Ease.CircleIn => PrimeTween.Ease.InCirc,
				EasingFunction.Ease.CircleOut => PrimeTween.Ease.OutCirc,
				EasingFunction.Ease.CircleInOut => PrimeTween.Ease.InOutCirc,
				EasingFunction.Ease.BounceIn => PrimeTween.Ease.InBounce,
				EasingFunction.Ease.BounceOut => PrimeTween.Ease.OutBounce,
				EasingFunction.Ease.BounceInOut => PrimeTween.Ease.InOutBounce,
				EasingFunction.Ease.BackIn => PrimeTween.Ease.InBack,
				EasingFunction.Ease.BackOut => PrimeTween.Ease.OutBack,
				EasingFunction.Ease.BackInOut => PrimeTween.Ease.InOutBack,
				EasingFunction.Ease.ElasticIn => PrimeTween.Ease.InElastic,
				EasingFunction.Ease.ElasticOut => PrimeTween.Ease.OutElastic,
				EasingFunction.Ease.ElasticInOut => PrimeTween.Ease.InOutElastic,
